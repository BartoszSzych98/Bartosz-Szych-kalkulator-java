...
import com.kodilla.game.Paper;
import com.kodilla.game.Rock;
import com.kodilla.game.Move;
import com.kodilla.game.Scissors;
...
public class Game {
    ...
    private static Game rpsGameInstance = null;

    private final String playerName;
    private int winCondition = 0, playerPoints = 0, computerPoints = 0;
    private Move playerLastMove = null, computerLastMove = null;
    private boolean isEnded = false, nextGame = false;

    private Game(final String playerName) {
    ...
    private Move makeMove(String player) {
        Scanner scanner = new Scanner(System.in);
        while (true) {
            String move = "";
            boolean isVerified = false;
