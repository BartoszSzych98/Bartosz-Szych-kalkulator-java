...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://bartoszszych98.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("bartoszych17@gmail.com");
        WebElement continue_button = driverTrello.findElement(By.id("login"));
        continue_button.submit();
        Thread.sleep(2000);

        driverTrello.findElement(By.id("password")).sendKeys("kodilla_password123");
